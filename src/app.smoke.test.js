...
describe('VJ Tam Tam app smoke', () => {
  ...
  it('initializes the app DOM and core controls without boot errors', () => {
    ...
    expect(document.querySelector('#bottom-live-strip #min-duration-slider').max).toBe('180')
    expect(document.querySelector('#bottom-live-strip #max-duration-slider').max).toBe('180')
