      ...
      <div id="app">
        ...
        <div id="left-drawer" class="left-drawer">
          ...
          <div id="advanced-controls-section" class="hidden">
            <input id="min-duration-slider" type="range" min="1" max="300" value="5">
            <input id="min-duration-input" type="number" min="1" max="300" value="5">
            <input id="max-duration-slider" type="range" min="1" max="300" value="5">
            <input id="max-duration-input" type="number" min="1" max="300" value="5">
