...
- `Story DoD Checklist`: `bmad-agent/tasks/checklists/story-dod-checklist.md`
...
5.  **Pre-Completion DoD Review & Cleanup:**
    ...
    - <critical_rule>Meticulously verify story against each item in `bmad-agent/tasks/checklists/story-dod-checklist.md`.</critical_rule>
