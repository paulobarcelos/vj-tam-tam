...
*Goal: To establish a fully functional and verifiable local development environment, ensuring all required tooling and third-party libraries are correctly installed and configured as per the architecture document.*
