...
- [ ] Task 1: Create Text Pool Section HTML Structure (AC: 1.1, 1.2)
  - [ ] Subtask 1.1: Add text pool section to left drawer HTML between media pool and advanced controls sections
  - [ ] Subtask 1.2: Create text input area with input field (placeholder: "Add a message...") and add button ("+")
  - [ ] Subtask 1.3: Apply consistent styling following UI-UX-Spec.md Section 5.2 drawer section patterns
  - [ ] Subtask 1.4: Ensure text section header follows existing media pool header styling patterns

- [ ] Task 2: Implement Text Input Event Handlers (AC: 1.2, 1.3, 1.4)
  - [ ] Subtask 2.1: Add click event listener to add button for text submission
  - [ ] Subtask 2.2: Add keydown event listener to input field for Enter key submission
  - [ ] Subtask 2.3: Implement text validation to prevent empty string submission
  - [ ] Subtask 2.4: Clear input field after successful text addition
  - [ ] Subtask 2.5: Add basic input sanitization and length limits (max 200 characters)

- [ ] Task 3: Extend StateManager for Text Pool Management (AC: 1.3)
  - [ ] Subtask 3.1: Add textPool array property to StateManager constructor
  - [ ] Subtask 3.2: Implement addText(text) method with validation and duplicate prevention
  - [ ] Subtask 3.3: Implement getTextPool() method for retrieving current text collection
  - [ ] Subtask 3.4: Add text pool data to localStorage persistence in getState() and loadState()
  - [ ] Subtask 3.5: Emit event bus notifications for text pool changes (textPool.added event)

- [ ] Task 4: Integrate Text Input with UIManager (AC: 1.1, 1.2, 1.3)
  - [ ] Subtask 4.1: Add text input DOM element references to UIManager constructor
  - [ ] Subtask 4.2: Initialize text input event listeners in UIManager.init() method
  - [ ] Subtask 4.3: Implement handleAddText() method in UIManager class
  - [ ] Subtask 4.4: Connect text input functionality to StateManager text pool methods
  - [ ] Subtask 4.5: Ensure text input area follows existing idle/active state visibility patterns

- [ ] Task 5: Add String Constants and Localization (AC: 1.1)
  - [ ] Subtask 5.1: Add text pool section strings to constants/strings.js
  - [ ] Subtask 5.2: Include placeholder text, button labels, and section header text
  - [ ] Subtask 5.3: Add validation messages for empty input and character limits
  - [ ] Subtask 5.4: Update UIManager to use centralized string constants

- [ ] Task 6: Testing and Validation (All ACs)
  - [ ] Subtask 6.1: Test text input field functionality and Enter key submission
  - [ ] Subtask 6.2: Test add button click submission and input validation
  - [ ] Subtask 6.3: Test empty input prevention and character limit enforcement
  - [ ] Subtask 6.4: Verify text pool state persistence across browser sessions
  - [ ] Subtask 6.5: Test integration with existing UI idle/active state management
